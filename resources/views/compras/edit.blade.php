        ...
        <div class="card-body">
            <form action="{{ route('compras.update', $compra->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion">{{ old('descripcion', $compra->descripcion) }}</textarea>
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    {{-- Botón Actualizar (Protegido en la ruta) --}}
                    @if (Auth::user()->hasPermissionTo('compras', 'editar'))
                        <button type="submit" class="btn btn-success">
                            <i class="fas fa-sync"></i> Actualizar Compra
                        </button>
                    @else
