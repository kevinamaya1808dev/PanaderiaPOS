    ...
    <div class="card shadow-sm border-0 mx-auto" style="max-width: 600px;">
        ...
        <div class="card-body p-4">
            <form action="{{ route('compras.store') }}" method="POST" id="form-movimientos">
                ...
                {{-- Responsable --}}
                <div class="mb-3">
                    <label class="form-label fw-bold text-primary">¿Quién realiza la compra?</label>
                    <div class="input-group">
                    ...
                    <small class="text-muted">Usuario registrado actualmente.</small>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const inputGasto = document.getElementById('concepto');
