...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0"><i class="fas fa-shopping-cart text-secondary me-2"></i> Registro de Compras</h2>
    ...
    {{-- INICIO DEL DISEÑO TIPO TARJETA (Igual al historial) --}}
    <div class="card shadow-sm border-0">
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                @if (Auth::user()->hasPermissionTo('compras', 'editar'))
                                    <a href="{{ route('compras.edit', $compra->id) }}" class="btn btn-sm btn-outline-warning me-1" title="Editar">
        ...
        {{-- Footer de la tarjeta con la paginación corregida --}}
