...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-history text-secondary me-2"></i> Historial de Turnos y Cajas</h2>
    </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        {{-- Usamos la variable $cajas (plural) que sí envía el controlador --}}
                        @forelse($cajas as $caja)
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <a href="{{ route('historial_cajas.show', $caja->id) }}" class="btn btn-sm btn-outline-primary">
